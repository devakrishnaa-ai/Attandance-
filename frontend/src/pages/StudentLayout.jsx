                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="font-bold text-lg text-gray-900 dark:text-white leading-tight">Student<br /><span className="text-indigo-600 text-sm">Portal</span></h2>
                            </div>
                        </div>
                ...
                <div className="p-4 md:p-8 max-w-7xl mx-auto">
                    ...
                    <div className="lg:hidden mb-6 flex items-center justify-between bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-gray-900 dark:text-white">Student Portal</span>
                        </div>
